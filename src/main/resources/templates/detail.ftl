...
<html lang="en">
  ...
  <body>
	...
	<input type="hidden" id="detail_post_id" th:value="${id}">
  <!-- Add this script tag -->
  <script>
      // Retrieve the value of id from the hidden input field
      var idValue = document.getElementById('detail_post_id').value;
